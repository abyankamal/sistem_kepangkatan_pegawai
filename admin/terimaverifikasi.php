...
<?php include("header.php")?>
    <div class="container mb-5">
        ...
        <h3 class="text-white shadow text-center card-header bg-info">Halaman Menerima Verifikasi Pegawai</h3>
          <div class="card card-body">
            <h5 class="text-bold text-center">Silahkan Masukan Keterangan Menerima Verifikasi</h5>
            <?php
              include "../koneksi.php";
              $id = $_GET['id'];
            ...
            ?>
            <form action="proses/verifikasiditerima.php" method="post" class="row" enctype="multipart/form-data">
